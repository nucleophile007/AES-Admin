...
export default function AdminAvailabilityPage() {
  ...
  // Load availability for selected program
  ...
  // Initial load and program change handler
  useEffect(() => {
  ...
  return (
    <div className="max-w-7xl mx-auto p-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600">Set available time slots for each tutoring program</p>
      </div>
      ...
      <div className="mb-4 p-4 bg-blue-50 rounded-lg border border-blue-200">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-blue-700">Set available time slots for this program</p>
          </div>
